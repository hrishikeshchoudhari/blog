defmodule BlogWeb.UsersAuth do
  ...
  the current_users:
      ...
      defmodule BlogWeb.PageLive do
        ...
        on_mount {BlogWeb.UsersAuth, :mount_current_users}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{BlogWeb.UsersAuth, :ensure_authenticated}] do
